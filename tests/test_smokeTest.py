...
class TestSmokeTest():
  ...
  def test_admin(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("adc")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("adc")
  ...
  def test_join(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Thiago")
    self.driver.find_element(By.NAME, "lname").send_keys("Gouveia")
    self.driver.find_element(By.NAME, "bizname").send_keys("PatoBranco")
